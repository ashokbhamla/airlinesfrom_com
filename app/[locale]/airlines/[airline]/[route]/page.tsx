...
import { generateAirlineCanonicalUrl, generateAlternateUrls, getCanonicalBaseUrl } from '@/lib/canonical';
...
{safeReplace(t?.flightPage?.destinationsOverview || '{airlineName} Destinations Overview', { airlineName })}
      ...
      <SchemaOrg data={{
        ...
        "url": `${siteUrl}/airlines/${airlineCode}/${params.route}`,
        "mainEntity": {
          "@type": "Airline",
          "name": airlineName,
          "iataCode": airlineCode.toUpperCase()
        ...
        "breadcrumb": {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 2,
              "name": "Airlines",
              "item": `${siteUrl}/airlines`
            },
            {
              "@type": "ListItem",
              "position": 3,
              "name": airlineName,
              "item": `${siteUrl}/airlines/${airlineCode}`
            },
            {
              "@type": "ListItem",
              "position": 4,
              "name": `${departureCity} to ${arrivalCity}`,
              "item": `${siteUrl}/airlines/${airlineCode}/${params.route}`
            }
          ]
        }
      }} />
      ...
      <SchemaOrg data={{
        ...
        "mainEntityOfPage": {
          "@type": "WebPage",
          "@id": `${siteUrl}/airlines/${airlineCode}/${params.route}`
        },
        "about": {
          "@type": "Place",
          "name": arrivalCity,
      ...
      <SchemaOrg data={{
        ...
        "distribution": {
          "@type": "DataDownload",
          "encodingFormat": "application/json",
          "contentUrl": `${siteUrl}/api/airlines/${airlineCode}/${params.route}/prices`
        }
      }} />
