    ...
    try {
      ...
      const crmResponse = await fetch(crmUrl, {
        ...
        body: JSON.stringify({
          ...
          source: 'landing',
          notes: `Flight: ${body.flightDetails.fromCity || body.flightDetails.from} to ${body.flightDetails.toCity || body.flightDetails.to}${body.flightDetails.price ? `. Price: $${body.flightDetails.price}` : ''}. Class: ${body.flightDetails.class || 'Economy'}. Submitted from AirlineFrom search page.`,
        }),
      });
